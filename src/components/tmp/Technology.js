...
class Technology extends React.Component {
    ...
    componentDidMount() {
        ...
        Promise.all([
          fetch("https://high-bedrock-268705.appspot.com/nytimeTechTab").then(valueNY => valueNY.json()),
          fetch("https://high-bedrock-268705.appspot.com/guardianTechTab").then(valueG => valueG.json())
          ])
          .then(([valueNY, valueG]) => {
