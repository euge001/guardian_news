...
class Business extends React.Component {
    ...
    componentDidMount() {
        ...
        Promise.all([
          fetch("https://high-bedrock-268705.appspot.com/nytimeBusinessTab").then(valueNY => valueNY.json()),
          fetch("https://high-bedrock-268705.appspot.com/guardianBusinessTab").then(valueG => valueG.json())
          ])
          .then(([valueNY, valueG]) => {
